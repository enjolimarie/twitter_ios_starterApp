...
// consumer: 5lUJuO5AUpPUCez4ewYDFrtgh
// secret : s5ynGqXzstUZwFPxVyMDkYh197qvHOcVM3kwv1o2TKhS1avCdS
// Cynthia's consumer: m77Y46tjz0NbPtmFv5Zgg43mv
// Cynthia's secret: WHPKwitfWjzwsAwTGHWhh9yhn5kRuAnlY2kZEoHbjRTVY8WiQW

import UIKit
import BDBOAuth1Manager

class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "m77Y46tjz0NbPtmFv5Zgg43mv", consumerSecret: "WHPKwitfWjzwsAwTGHWhh9yhn5kRuAnlY2kZEoHbjRTVY8WiQW")
    var loginSuccess: (() -> ())?
